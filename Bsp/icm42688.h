...
#define ICM42688_CS_HIGH HAL_GPIO_WritePin(ICM_CS_GPIO_Port, ICM_CS_Pin,1)
#define ICM42688_CS_LOW  HAL_GPIO_WritePin(ICM_CS_GPIO_Port, ICM_CS_Pin,0)

#define ICM42688_ACC_SAMPLE_DEFAULT     ( AFS_8G )          // 在这设置默认的 加速度计 初始化量程
#define ICM42688_GYRO_SAMPLE_DEFAULT    ( GFS_1000DPS )    // 在这设置默认的 陀螺仪   初始化量程

#define ICM42688_TIMEOUT_COUNT      ( 0x00FF )                                  // ICM20602 超时计数
